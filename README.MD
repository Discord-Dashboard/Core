...
```js
...
  optionType: DBD.formTypes.multipleChannelsSelect(disabled, required),
...
```
...
```js
...
  optionType: DBD.formTypes.multipleRolesSelect(disabled, required),
...
```
...
```js
...
  optionType: DBD.formTypes.multipleSelect(list, disabled, required),
...
```
